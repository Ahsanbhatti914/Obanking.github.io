			...
			if(rs.next() == true)
			{
				...
				if(em.equals(sess_email) && ps.equals(sess_password))
				{
	   				...
	   				{	
						...
						out.println("<h1>HERE IS YOUR BALANCE DETAILS!!</h1>");
						out.println("<table><tr><th>ACCOUNT ID</th><th>CURRENT BALANCE</th><th>LAST TRANSACTION</th><th>LAST TRANSACTION BALANCE</th><th>LAST TRANSACTION DATE</th><th>ACCOUNT DATE</th></tr>");
						while(rs1.next())
						{
